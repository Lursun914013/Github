...
mshta VBScript:Execute("Set a=CreateObject(""WScript.Shell""):Set b=a.CreateShortcut(a.SpecialFolders(""Desktop"") & ""\TIM.lnk""):b.TargetPath=""%~dp0Bin\TIM.exe"":b.WorkingDirectory=""%~dp0"":b.Save:close")
